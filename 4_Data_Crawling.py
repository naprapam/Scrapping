...
for month in range(1,13):
    for day_m in range(1,35): #Mendefinisikan Tanggal
        ...
        while True:
            ...
            for block in page_block:
                ...
                result_m.append({'Tanggal': day_m, 'Bulan': month, 'Judul': judul}) #Menyimpan judul
        ...
        #Simpan ke csv
        with open("Kompas_thn_Judul1.csv", "w", newline="", encoding="utf-8") as csvfile:
            fieldnames = ["Nomor", "Tanggal", "Bulan", "Judul"]
